...
(def demo-dir "/Users/andrzejfricze/rust-jolt/jolt-rust-interop-handoff/diplomat-backend/semver-demo")

(require '[jolt.ffi :as ffi])
(ffi/load-library (str demo-dir "/semver-capi/target/release/libsemver_capi.dylib"))
(ffi/load-library (str demo-dir "/libsemver_capi_shim.dylib"))
