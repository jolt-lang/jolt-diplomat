...
typedef struct DiplomatCallback_Reducer_apply_twice_leaky_f {
    const void* data;
    int32_t (*run_callback)(const void*, int32_t );
    void (*destructor)(const void*);
} DiplomatCallback_Reducer_apply_twice_leaky_f;
...
int32_t Reducer_apply_twice_leaky(int32_t x, DiplomatCallback_Reducer_apply_twice_leaky_f f_cb_wrap);
